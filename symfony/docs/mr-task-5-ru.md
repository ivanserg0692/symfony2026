...
<!-- plantuml src="plantuml/news-export-ru/pipeline.puml" alt="Pipeline batch-экспорта новостей" out="images/plantuml/news-export-ru/pipeline.png" -->
![Pipeline batch-экспорта новостей](images/plantuml/news-export-ru/pipeline.png)
<!-- /plantuml -->
...
<!-- plantuml src="plantuml/news-export-ru/startup.puml" alt="Ответственность запуска экспорта" out="images/plantuml/news-export-ru/startup.png" -->
![Ответственность запуска экспорта](images/plantuml/news-export-ru/startup.png)
<!-- /plantuml -->
...
<!-- plantuml src="plantuml/news-export-ru/message-batch-processing.puml" alt="Batch-обработка messages в handler" out="images/plantuml/news-export-ru/message-batch-processing.png" -->
![Batch-обработка messages в handler](images/plantuml/news-export-ru/message-batch-processing.png)
<!-- /plantuml -->
...
<!-- plantuml src="plantuml/news-export-ru/retry.puml" alt="Поведение retry" out="images/plantuml/news-export-ru/retry.png" -->
![Поведение retry](images/plantuml/news-export-ru/retry.png)
<!-- /plantuml -->
...
<!-- plantuml src="plantuml/news-export-ru/chunk-merge.puml" alt="Порядок CSV chunks и финальное объединение" out="images/plantuml/news-export-ru/chunk-merge.png" -->
![Порядок CSV chunks и финальное объединение](images/plantuml/news-export-ru/chunk-merge.png)
<!-- /plantuml -->
...
<!-- plantuml src="plantuml/news-export-ru/finalization.puml" alt="Финализация экспорта новостей" out="images/plantuml/news-export-ru/finalization.png" -->
![Финализация экспорта новостей](images/plantuml/news-export-ru/finalization.png)
<!-- /plantuml -->
...
<!-- plantuml src="plantuml/news-export-ru/admin-visibility.puml" alt="Видимость результата в админке" out="images/plantuml/news-export-ru/admin-visibility.png" -->
![Видимость результата в админке](images/plantuml/news-export-ru/admin-visibility.png)
<!-- /plantuml -->
...
<!-- plantuml src="plantuml/news-export-ru/components.puml" alt="Компоненты экспорта новостей" out="images/plantuml/news-export-ru/components.png" -->
![Компоненты экспорта новостей](images/plantuml/news-export-ru/components.png)
<!-- /plantuml -->
